...
namespace Almacenes_Paul_Inventario.Clases
{
    class Validacion
    {
        ...
        public void LetrasNumerosGuion(KeyPressEventArgs e)
        {
            try
            {
                if (Char.IsLetter(e.KeyChar))
        ...
        public void Dinero(KeyPressEventArgs e, TextBox txt)
        {
            try
            {
        ...
        public bool ValidarCampoDecimal(TextBox cajaTexto)
        {
            try
            {
                decimal d = Convert.ToDecimal(cajaTexto.Text);
                return true;
            }
            catch (Exception ex)
            {
